function [state_red,inv_state_red,n_g] = krylov_reduction(g0,g1,n_v,n_g0,n_Z,n_p,n_arnoldi,varargin)
...
%    n_g0 = number of state variables to be reduced
...
B_pg = -g1(n_total+1:n_total+n_p,n_total+1:n_total+n_p)\g1(n_total+1:n_total+n_p,n_v+1:n_v+n_g0);
B_pZ = -g1(n_total+1:n_total+n_p,n_total+1:n_total+n_p)\g1(n_total+1:n_total+n_p,n_v+n_g0+1:n_v+n_g0+n_Z);
B_gg = g1(n_v+1:n_v+n_g0,n_v+1:n_v+n_g0);
B_gv = g1(n_v+1:n_v+n_g0,1:n_v);
B_gp = g1(n_v+1:n_v+n_g0,n_total+1:n_total+n_p);
...
state_red(n_v+1:n_v+n_g,n_v+1:n_v+n_g0) = V_g';
state_red(n_v+n_g+1:n_v+n_g+n_Z,n_v+n_g0+1:n_v+n_g0+n_Z) = speye(n_Z);
...
inv_state_red(n_v+1:n_v+n_g0,n_v+1:n_g+n_v) = V_g;
...
inv_state_red(n_v+n_g0+1:n_total,n_v+n_g+1:n_v+n_g+n_Z) = speye(n_Z);
